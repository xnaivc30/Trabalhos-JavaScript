...
function caixinha4(){
    let oxi5 = document.getElementById("input9").value;
    let radio5 = document.getElementById("input10").checked;
    let radio6 = document.getElementById("input11").checked;
        if (oxi5 < 300 && radio5 == false && radio6 == true){
            document.getElementById("h3_avaliacao").textContent = "Não foi culpa do Odisseu"
        }
        else if (oxi5 >= 300 && oxi5 < 450 && radio5 == true && radio6 == false){
            document.getElementById("h3_avaliacao").textContent = "Talvez tenha sido culpa do Odisseu"
        }
        else if (oxi5 >= 450 && radio5 == true && radio6 == false){
            document.getElementById("h3_avaliacao").textContent = "Foi culpa do Odisseu"
        }
        else if (oxi5 < 0 || oxi5 > 601){
            document.getElementById("h3_avaliacao").textContent = "Mintira, troca isso ai"
        }
}
